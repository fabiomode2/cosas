...
| $v_2$ | $v_1$      |
| $v_3$ | $v_1$      |
- **Matriz de adyacencia**. Es una matriz $n \times n$ siendo $n$ el grado del grafo en la cual la entrada $a_{ij}$ es el nº de ejes que conectan $v_i$ con $v_j$. Para un grafo simple, la matriz es binaria y la diagonal son $0s$.
